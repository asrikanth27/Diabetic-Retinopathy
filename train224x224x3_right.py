...
x_train = np.load("../x_trainright0-rest.npy")
y_train = np.load("../y_trainright0-rest.npy")
...
filepath="../custom_net_checkpoint_right0-rest.h5"
...
history = model.fit(x=x_train, y=y_train, batch_size=96, epochs=10,verbose=1, validation_split=0.1, shuffle=True, callbacks=callbacks_list)
print("\n\nTraining Complete!!!")

model.save("../custom_net_complete_right0-rest.h5")
print("Model saved")
