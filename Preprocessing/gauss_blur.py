...
input_path = "/home/spectrumlab/srikanth/files/label1"
df = pd.read_csv("/home/spectrumlab/srikanth/files/trLabels.csv")

train_files = glob.glob(os.path.join(input_path,"*.jpeg"))
out_directory = "/home/spectrumlab/srikanth/files/label1_processed"
